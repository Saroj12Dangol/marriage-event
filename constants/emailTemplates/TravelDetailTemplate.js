...
<body>
    ...
    <div style="padding: 20px;">
        ...
        <p>If you haven't already, kindly send travel detail through our website at <a href="${process.env.TRAVEL_DETAIL_URL}/${eventId}">www.indha.com.au</a> Your prompt response would be greatly appreciated. </p>
